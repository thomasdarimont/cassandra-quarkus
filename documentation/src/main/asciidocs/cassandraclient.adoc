...
The solution is located in the `quickstart` https://github.com/datastax/cassandra-quarkus/tree/master/quickstart[directory].
...
To see the full list of settings, please refer to the https://github.com/datastax/java-driver/blob/4.x/core/src/main/resources/reference.conf[reference.conf]
...
In the `src/main/resources/META-INF/resources` directory, add a `fruits.html` file with the content from this https://github.com/datastax/cassandra-quarkus/tree/master/quickstart/src/main/resources/META-INF/resources/fruits.html[fruits.html] file in it.
...
For the full list of available metrics, please refer to the https://github.com/datastax/java-driver/blob/4.x/core/src/main/resources/reference.conf[reference.conf] and the `advanced.metrics` section.
